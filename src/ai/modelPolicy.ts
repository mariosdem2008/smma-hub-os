 ...
 * - gpt-5-nano: cheapest (great for classify/extract/summarize)
 * - gpt-5-mini: better general chat + reliability for tool-like tasks
 *
 * If you need a lower-cost long-output option, set an env override per task
 * to another model without touching code.
 */

const DEFAULT_POLICIES: Record<TaskType, TaskModelPolicy> = {
  [TaskType.CHAT_GENERAL]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.4 } },
    prod: { provider: "openai", model: "gpt-5-mini", params: { temperature: 0.4 } },
  },

  [TaskType.CHAT_ADMIN_ONBOARDING]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.2 } },
    prod: { provider: "openai", model: "gpt-5-mini", params: { temperature: 0.2 } },
  },

  [TaskType.AGENCY_ADMIN_SETUP_GUIDED_V2]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.3 } },
    prod: { provider: "openai", model: "gpt-5-mini", params: { temperature: 0.3 } },
  },
  ...
  [TaskType.AGENCY_ADMIN_SETUP_EXTRACT]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.1 } },
    prod: { provider: "openai", model: "gpt-5-mini", params: { temperature: 0.1 } },
  },
  ...
  [TaskType.SUMMARIZE]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.2 } },
    prod: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.2 } },
  },

  [TaskType.EXTRACT_STRUCTURED]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.1 } },
    prod: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.1 } },
  },

  [TaskType.CLASSIFY_INTENT]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0 } },
    prod: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0 } },
  },
  ...
  [TaskType.CONTENT_IDEAS]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0.8 } },
    prod: { provider: "openai", model: "gpt-5-mini", params: { temperature: 0.8 } },
  },
  ...
  [TaskType.TOOL_EXECUTION]: {
    dev: { provider: "openai", model: "gpt-5-nano", params: { temperature: 0 } },
    prod: { provider: "openai", model: "gpt-5-mini", params: { temperature: 0 } },
  },
...
function resolveProviderOverride(taskType: TaskType, mode: EnvMode): Provider | undefined {
  return (readEnv(`AI_PROVIDER__${taskType}__${mode}`) ??
    readEnv(`AI_PROVIDER__${taskType}`) ??
    readEnv(`AI_PROVIDER__${mode}`) ??
    readEnv("AI_PROVIDER")) as Provider | undefined
}
