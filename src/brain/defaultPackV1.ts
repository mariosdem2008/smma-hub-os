...
export type TemplateBrainDocument<M extends BrainModule = BrainModule> = {
  module: M;
  title: string;
...
export const DEFAULT_BRAIN_PACK_V1: ReadonlyArray<DefaultPackDoc> = [
  ...
  },
  {
    ...
    content_json: {
      ...
      response_templates: [
        "Thanks for reaching out — I can help. To make sure this is accurate, can you confirm: (1) the goal, (2) the offer, and (3) the target audience?",
        "I can draft a first pass. I’ll label assumptions and leave placeholders where details are missing.",
        "I can’t confirm that without a source. If you share the exact numbers or proof, I’ll incorporate them safely.",
      ],
      tone_guidelines:
...
export function renderDefaultBrainPackV1(
  agencyFields: Partial<AgencyTemplateFields>
): Array<DefaultPackDoc> {
