    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div
          ...
          className="mt-64 mx-auto max-w-5xl"
        >
          <div className="glass-card gradient-border-animated rounded-md p-32 md:p-48">
            <div className="grid gap-48 lg:grid-cols-2">
              {/* What's Included */}
              <div>
                <h3 className="text-xl font-semibold mb-24 text-foreground">What's Included (All Plans)</h3>
              ...
              {/* ROI Guarantee & CTA */}
              <div className="glass-card rounded-md p-32 md:p-40 bg-white/5">
                ...
                <div className="mt-32 pt-24 border-t border-white/10">
                  ...
                  <p className="mt-12 text-text-secondary leading-body text-body-mobile md:text-body-desktop">
                  ...
                  <div className="mt-24 flex flex-col gap-16">
                    ...
                    >
                      <a href={CAL_LINK} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-8">
                    ...
                    >
                      <a href="#" className="inline-flex items-center justify-center gap-8">
