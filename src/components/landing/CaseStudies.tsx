...
export function CaseStudiesSection() {
  return (
    <section id="results" className="py-20 border-y border-border/50 bg-surface/30">
                ...
                <div className="grid gap-8 md:grid-cols-12 md:items-center">
                  <div className="md:col-span-5 lg:col-span-4">
                    <div className="p-6 rounded-lg bg-card border border-border">
                        ...
                        <p className="text-sm text-muted-foreground mb-4"><strong>Challenge:</strong> {study.challenge}</p>
                  ...
                  <div className="md:col-span-7 lg:col-span-8">
                    <div className="p-6 rounded-lg bg-card border border-border">
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center border-t border-border/50 pt-5">
