  ...
  return (
    ...
    >
      <div className="container mx-auto px-[4px]">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="px-[24px] py-[16px] text-left text-small-text font-medium text-text-muted tracking-uppercase">
                    Feature
                  </th>
                  <th className="px-[24px] py-[16px] text-left text-small-text font-medium text-text-muted tracking-uppercase">
                    Hiring a Strategist
                  ...
                  <th className="px-[24px] py-[16px] text-left text-small-text font-medium text-brand-primary tracking-uppercase comparison-highlight">
                    SMMAHUB
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {COMPARISON_DATA.map((row, index) => (
                  ...
                  >
                    <td className="px-[24px] py-[16px] text-body-desktop font-medium text-foreground">
                      {row.feature}
                    </td>
                    <td className="px-[24px] py-[16px] text-body-desktop text-text-secondary">
                    ...
                    <td className="px-[24px] py-[16px] text-body-desktop comparison-highlight">
                      <div className="flex items-center gap-[8px]">
        ...
        {/* Mobile Cards */}
        <div className="mt-[48px] md:hidden space-y-[16px]">
          {COMPARISON_DATA.map((row, index) => (
            <motion.div
              key={row.feature}
              initial={{ opacity: 0, y: 20 }}
              ...
              className="glass-card glass-card-hover rounded-md p-[24px]"
            >
              <h4 className="font-semibold text-foreground mb-[16px]">{row.feature}</h4>
              <div className="space-y-[12px] text-body-mobile">
                ...
                <div className="flex justify-between items-center pt-[12px] border-t border-white/10">
