      ...
      <Card className="py-10">
        <CardContent className="space-y-5">
          <PremiumInlineEmpty
            ...
            description="Connect your Meta Ad Account to view campaign performance and insights."
          />
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-5">
        <PremiumStatCard icon={DollarSign} label="Total Spend" value={`$${totals.spend.toFixed(2)}`} tone="success" />
        <PremiumStatCard icon={Eye} label="Impressions" value={totals.impressions.toLocaleString()} />
        <PremiumStatCard icon={MousePointerClick} label="Clicks" value={totals.clicks.toLocaleString()} tone="accent" />
        <PremiumStatCard icon={Users} label="Reach" value={totals.reach.toLocaleString()} tone="primary" />
        <PremiumStatCard icon={Target} label="Conversions" value={totals.conversions.toLocaleString()} tone="warning" />
      </div>
        ...
        <CardContent>
          {!campaigns || campaigns.length === 0 ? (
            <PremiumInlineEmpty
              ...
              description='Click "Sync Data" to fetch campaign delivery from connected accounts.'
              className="py-8"
            />
          ) : (
