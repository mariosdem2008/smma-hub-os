        ...
        <Card className="border-primary bg-primary/5">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-lg">
                  First 25 users only - Lock in your price forever
                </CardDescription>
              </div>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  <CardTitle>LTD Starter - €147</CardTitle>
                ...
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-sm">Starter plan features forever</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="h-4 w-4 text-primary mt-1" />
                      <span className="text-sm">Early Adopter badge</span>
                    </li>
                  </ul>
                  <Button className="w-full mt-4" onClick={() => handleSelectPlan('ltd_starter')}>
                    Get LTD Starter
                  </Button>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                  <CardTitle>LTD Pro - €247</CardTitle>
                  <CardDescription>One-time payment</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <Check className="h-4 w-4 text-primary mt-1" />
                      <span className="text-sm">Pro plan features forever</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="h-4 w-4 text-primary mt-1" />
                      <span className="text-sm">Early Adopter badge</span>
                  ...
                  <Button className="w-full mt-4" onClick={() => handleSelectPlan('ltd_pro')}>
                    Get LTD Pro
                  </Button>
                </CardContent>
              </Card>
